  ...
  protected $fillable = [
   ...
   public function addComment($body)
    ...
    public static function archives()
    {
      ...
      return static::selectRaw('year(created_at) as year, monthname(created_at) as month, count(*) as published')->groupBy('year','month')->orderByRaw('min(created_at) desc')->get()->toArray();
    }
}
